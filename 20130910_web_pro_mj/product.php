...
<?php
	$head_content = array('Kracud-san‎', 'Durian chips', 'Lotus Crystal', 'Batik fabrics', 'Coconut shell');
	$part_content = glob('product-content/product*.html');
?>
...
<div class="content-wrapper">
	<div class="content-container">
		...
		<div id="content-icon-wrapper">			
			...
			<a href="product.php"><div id="content-icon" class="icon-page-active">
				<p>p</p>
			</div></a>
...
<script type="text/javascript" src="css/wowSilder/script2.js"></script>
